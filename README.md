...
**Note:** This repository is specific to JavaScrpit. Please check [Javascript Interview questions](https://github.com/Deepak081999/JAVASCRPIT).<br><br><br><br><br><br><br><br>
...
<table>
    ...
    <tr>
        <td>6</td>
        <td><a href="#what-is-the-virtual-dom">What is the Virtual DOM?</a></td>
    </tr>
    <tr>
        <td>7</td>
        <td><a href="#how-does-react-use-the-virtual-dom">How does React use the Virtual DOM?</a></td>
    </tr>
    <tr>
        <td>8</td>
        <td><a href="#what-is-the-difference-between-functional-and-class-components">What is the difference between Functional and Class Components?</a></td>
    </tr>
    <tr>
        <td>9</td>
        <td><a href="#what-are-react-hooks">What are React Hooks?</a></td>
    </tr>
    <tr>
        <td>10</td>
    ...
    <tr>
        <td>13</td>
        <td><a href="#what-is-react-lifecycle">What is React Lifecycle?</a></td>
    </tr>
    <tr>
        <td>14</td>
        <td><a href="#what-is-the-use-of-useeffect-hook">What is the use of useEffect Hook?</a></td>
    </tr>
    <tr>
        <td>15</td>
        <td><a href="#what-are-react-fragments">What are React Fragments?</a></td>
    </tr>
    <tr>
        <td>16</td>
        <td><a href="#what-is-context-api-in-react">What is Context API in React?</a></td>
    </tr>
    <tr>
        <td>17</td>
        <td><a href="#what-is-redux-in-react">What is Redux in React?</a></td>
    </tr>
    <tr>
        <td>18</td>
        <td><a href="#what-is-the-difference-between-redux-and-context-api">What is the difference between Redux and Context API?</a></td>
    </tr>
    <tr>
        <td>19</td>
    ...
    <tr>
        <td>20</td>
        <td><a href="#what-is-lazy-loading-in-react">What is Lazy Loading in React?</a></td>
    </tr>
    <tr>
        <td>21</td>
        <td><a href="#what-is-code-splitting-in-react">What is Code Splitting in React?</a></td>
    </tr>
    <tr>
        <td>22</td>
        <td><a href="#how-does-react-handle-events">How does React handle events?</a></td>
    </tr>
    <tr>
        <td>23</td>
        <td><a href="#what-is-the-use-of-refs-in-react">What is the use of refs in React?</a></td>
    </tr>
    <tr>
        <td>24</td>
        <td><a href="#what-are-higher-order-components-hocs">What are Higher-Order Components (HOCs)?</a></td>
    </tr>
    <tr>
        <td>25</td>
        <td><a href="#what-are-controlled-and-uncontrolled-components">What are Controlled and Uncontrolled Components?</a></td>
    </tr>
    <tr>
        <td>26</td>
        <td><a href="#what-are-error-boundaries-in-react">What are Error Boundaries in React?</a></td>
    </tr>
    <tr>
        <td>27</td>
        <td><a href="#what-is-react-memo">What is React.memo?</a></td>
    </tr>
    <tr>
        <td>28</td>
        <td><a href="#what-is-the-purpose-of-usecallback-hook">What is the purpose of useCallback Hook?</a></td>
    </tr>
    <tr>
        <td>29</td>
        <td><a href="#what-is-the-purpose-of-usememo-hook">What is the purpose of useMemo Hook?</a></td>
    </tr>
    <tr>
        <td>30</td>
        <td><a href="#what-is-server-side-rendering-ssr-in-react">What is Server-Side Rendering (SSR) in React?</a></td>
    </tr>
    <tr>
        <td>31</td>
        <td><a href="#what-is-static-site-generation-ssg-in-react">What is Static Site Generation (SSG) in React?</a></td>
    </tr>
    <tr>
        <td>32</td>
        <td><a href="#how-does-react-handle-form-submission">How does React handle form submission?</a></td>
    </tr>
    <tr>
        <td>33</td>
        <td><a href="#what-is-react-portal">What is React Portal?</a></td>
    </tr>
    <tr>
        <td>34</td>
        <td><a href="#what-are-react-suspense-and-lazy">What are React Suspense and Lazy?</a></td>
    </tr>
    <tr>
        <td>35</td>
        <td><a href="#what-is-the-difference-between-useeffect-and-componentdidmount">What is the difference between useEffect and componentDidMount?</a></td>
    </tr>
    <tr>
        <td>36</td>
    ...
    <tr>
        <td>38</td>
        <td><a href="#how-to-optimize-performance-in-react">How to optimize performance in React?</a></td>
    </tr>
    <tr>
        <td>39</td>
        <td><a href="#what-are-react-strict-mode-and-its-benefits">What are React Strict Mode and its benefits?</a></td>
    </tr>
    <tr>
        <td>40</td>
        <td><a href="#what-is-nextjs-and-how-does-it-extend-react">What is Next.js and how does it extend React?</a></td>
    </tr>
    <tr>
        <td>41</td>
        <td><a href="#what-is-the-difference-between-usecallback-and-usememo">What is the difference between useCallback and useMemo?</a></td>
    </tr>
    <tr>
        <td>42</td>
        <td><a href="#how-does-react-handle-key-prop-in-lists">How does React handle key prop in lists?</a></td>
    </tr>
    <tr>
        <td>43</td>
        <td><a href="#what-is-the-use-of-proptypes-in-react">What is the use of PropTypes in React?</a></td>
    </tr>
    <tr>
        <td>44</td>
        <td><a href="#how-to-create-a-custom-hook-in-react">How to create a custom Hook in React?</a></td>
    </tr>
    <tr>
        <td>45</td>
        <td><a href="#what-is-the-difference-between-reactdomrender-and-reactdomcreateportal">What is the difference between ReactDOM.render and ReactDOM.createPortal?</a></td>
    </tr>
    <tr>
        <td>46</td>
        <td><a href="#what-is-the-role-of-babel-in-react">What is the role of Babel in React?</a></td>
    </tr>
    <tr>
        <td>47</td>
        <td><a href="#what-is-the-purpose-of-react-strict-mode">What is the purpose of React Strict Mode?</a></td>
    </tr>
    <tr>
        <td>48</td>
        <td><a href="#how-to-handle-errors-in-react">How to handle errors in React?</a></td>
    </tr>
    <tr>
        <td>49</td>
        <td><a href="#how-to-integrate-redux-with-react">How to integrate Redux with React?</a></td>
    </tr>
    <tr>
        <td>50</td>
        <td><a href="#what-are-redux-thunk-and-redux-saga">What are Redux Thunk and Redux Saga?</a></td>
    </tr>
    <tr>
        <td>51</td>
        <td><a href="#what-is-the-difference-between-redux-and-mobx">What is the difference between Redux and MobX?</a></td>
    </tr>
    <tr>
        <td>52</td>
        <td><a href="#how-to-debug-react-applications">How to debug React applications?</a></td>
    </tr>
    <tr>
        <td>53</td>
        <td><a href="#how-does-react-handle-asynchronous-state-updates">How does React handle asynchronous state updates?</a></td>
    </tr>
    <tr>
        <td>54</td>
        <td><a href="#what-is-the-use-of-useimperativehandle-hook">What is the use of useImperativeHandle Hook?</a></td>
    </tr>
    <tr>
        <td>55</td>
        <td><a href="#how-to-implement-dark-mode-in-react">How to implement Dark Mode in React?</a></td>
    </tr>
    <tr>
        <td>56</td>
    ...
    <tr>
        <td>57</td>
        <td><a href="#how-to-use-react-with-typescript">How to use React with TypeScript?</a></td>
    </tr>
    <tr>
        <td>58</td>
        <td><a href="#how-to-optimize-react-app-performance">How to optimize React app performance?</a></td>
    </tr>
    <tr>
        <td>59</td>
    ...
    <tr>
        <td>60</td>
        <td><a href="#how-does-react-handle-server-side-rendering-ssr">How does React handle Server-Side Rendering (SSR)?</a></td>
    </tr>
    <tr>
        <td>61</td>
        <td><a href="#what-is-the-use-of-usecontext-hook">What is the use of useContext Hook?</a></td>
    </tr>
    <tr>
        <td>62</td>
        <td><a href="#what-is-the-use-of-useReducer-hook">What is the use of useReducer Hook?</a></td>
    </tr>
    <tr>
        <td>63</td>
        <td><a href="#how-to-test-react-components">How to test React components?</a></td>
    </tr>
    <tr>
        <td>64</td>
        <td><a href="#what-is-the-use-of-react-testing-library">What is the use of React Testing Library?</a></td>
    </tr>
    <tr>
        <td>65</td>
        <td><a href="#what-is-the-difference-between-jest-and-mocha">What is the difference between Jest and Mocha?</a></td>
    </tr>
    <tr>
        <td>66</td>
        <td><a href="#how-to-deploy-a-react-app">How to deploy a React app?</a></td>
    </tr>
    <tr>
        <td>67</td>
        <td><a href="#what-is-the-use-of-webpack-in-react">What is the use of Webpack in React?</a></td>
    </tr>
    <tr>
        <td>68</td>
        <td><a href="#how-to-implement-authentication-in-react">How to implement authentication in React?</a></td>
    </tr>
    <tr>
        <td>69</td>
        <td><a href="#what-are-react-performance-optimization-techniques">What are React performance optimization techniques?</a></td>
    </tr>
    <tr>
        <td>70</td>
        <td><a href="#how-to-use-react-with-graphql">How to use React with GraphQL?</a></td>
    </tr>
    <tr>
        <td>71</td>
    ...
    <tr>
        <td>72</td>
        <td><a href="#how-to-use-react-with-material-ui">How to use React with Material-UI?</a></td>
    </tr>
    <tr>
        <td>73</td>
        <td><a href="#what-is-the-difference-between-react-class-components-and-functional-components">What is the difference between React Class Components and Functional Components?</a></td>
    </tr>
    <tr>
        <td>74</td>
        <td><a href="#how-to-implement-infinite-scroll-in-react">How to implement infinite scroll in React?</a></td>
    </tr>
    <tr>
        <td>75</td>
        <td><a href="#what-is-the-use-of-useLayoutEffect-hook">What is the use of useLayoutEffect Hook?</a></td>
    </tr>
    <tr>
        <td>76</td>
        <td><a href="#how-to-integrate-react-with-firebase">How to integrate React with Firebase?</a></td>
    </tr>
    <tr>
        <td>77</td>
        <td><a href="#what-is-the-use-of-useDeferredValue-hook">What is the use of useDeferredValue Hook?</a></td>
    </tr>
    <tr>
        <td>78</td>
        <td><a href="#how-to-handle-file-uploads-in-react">How to handle file uploads in React?</a></td>
    </tr>
    <tr>
        <td>79</td>
        <td><a href="#how-to-create-a-drag-and-drop-interface-in-react">How to create a drag-and-drop interface in React?</a></td>
    </tr>
    <tr>
        <td>80</td>
        <td><a href="#how-to-implement-multi-language-support-in-react">How to implement multi-language support in React?</a></td>
    </tr>
      <tr>
        <td>81</td>
        <td><a href="#how-to-handle-forms-in-react">How to handle forms in React?</a></td>
    </tr>
    <tr>
        <td>82</td>
        <td><a href="#what-is-the-use-of-useTransition-hook">What is the use of useTransition Hook?</a></td>
    </tr>
    <tr>
        <td>83</td>
        <td><a href="#how-to-implement-server-side-pagination-in-react">How to implement server-side pagination in React?</a></td>
    </tr>
    <tr>
        <td>84</td>
        <td><a href="#what-is-the-use-of-useSyncExternalStore-hook">What is the use of useSyncExternalStore Hook?</a></td>
    </tr>
    <tr>
        <td>85</td>
        <td><a href="#how-to-use-context-api-for-state-management">How to use Context API for state management?</a></td>
    </tr>
    <tr>
        <td>86</td>
        <td><a href="#how-to-implement-dynamic-theming-in-react">How to implement dynamic theming in React?</a></td>
    </tr>
    <tr>
        <td>87</td>
        <td><a href="#how-to-handle-memory-leaks-in-react">How to handle memory leaks in React?</a></td>
    </tr>
    <tr>
        <td>88</td>
        <td><a href="#what-are-error-boundaries-in-react">What are Error Boundaries in React?</a></td>
    ...
    <tr>
        <td>89</td>
        <td><a href="#how-to-integrate-third-party-libraries-in-react">How to integrate third-party libraries in React?</a></td>
    </tr>
    <tr>
        <td>90</td>
        <td><a href="#what-are-the-best-practices-for-structuring-a-react-project">What are the best practices for structuring a React project?</a></td>
    </tr>
    <tr>
        <th>#</th>
        <th>React Internationalization</th>
    </tr>
    <tr>
        <td>90</td>
    ...
    <tr>
        <td>98</td>
        <td><a href="#what-is-the-purpose-of-reacttestutils-package">What is the purpose of the ReactTestUtils package?</a></td>
    </tr>
    <tr>
        <td>99</td>
    ...
    <tr>
        <td>115</td>
        <td><a href="#should-i-keep-all-components-state-in-redux-store">Should I keep all component states in the Redux store?</a></td>
    </tr>
    <tr>
        <td>116</td>
        <td><a href="#what-is-the-proper-way-to-access-redux-store">What is the proper way to access the Redux store?</a></td>
    </tr>
    <tr>
        <td>117</td>
    ...
    <tr>
        <td>129</td>
        <td><a href="#what-are-redux-selectors-and-why-use-them">What are Redux selectors and why use them?</a></td>
    </tr>
    <tr>
        <td>130</td>
    ...
    <tr>
        ...
        <th>#</th>
        <th>React Supported Libraries and Integration</th>
    </tr>
    <tr>
        <td>140</td>
    ...
    <tr>
        <td>153</td>
        <td><a href="#what-are-the-main-features-of-reselect-library">What are the main features of the reselect library?</a></td>
    </tr>
    <tr>
        <td>154</td>
    ...
    <tr>
        <td>157</td>
        <td><a href="#how-redux-form-initialvalues-get-updated-from-state">How Redux Form initial values get updated from state?</a></td>
    </tr>
    <tr>
        <td>158</td>
        <td><a href="#how-react-proptypes-allow-different-types-for-one-prop">How React PropTypes allow different types for one prop?</a></td>
    </tr>
    <tr>
        <td>159</td>
        <td><a href="#can-i-import-an-svg-file-as-react-component">Can I import an SVG file as a React component?</a></td>
    </tr>
    <tr>
        <td>160</td>
    ...
    <tr>
        <td>161</td>
        <td><a href="#how-to-pass-numbers-to-react-component">How to pass numbers to a React component?</a></td>
    </tr>
    <tr>
        <td>162</td>
        <td><a href="#do-i-need-to-keep-all-my-state-into-redux-should-i-ever-use-react-internal-state">Do I need to keep all my state in Redux? Should I ever use React internal state?</a></td>
    </tr>
    <tr>
        <td>163</td>
    ...
    <tr>
        <td>173</td>
        <td><a href="#can-you-describe-about-componentdidcatch-lifecycle-method-signature">Can you describe the componentDidCatch lifecycle method signature?</a></td>
    </tr>
    <tr>
        <td>174</td>
        <td><a href="#in-which-scenarios-do-error-boundaries-not-catch-errors">In which scenarios do error boundaries not catch errors?</a></td>
    </tr>
    <tr>
        <td>175</td>
    ...
    <tr>
        <td>177</td>
        <td><a href="#what-is-the-benefit-of-component-stack-trace-from-error-boundary">What is the benefit of component stack trace from an error boundary?</a></td>
    </tr>
    <tr>
        <td>178</td>
    ...
    <tr>
        <td>179</td>
        <td><a href="#what-is-the-purpose-of-displayname-class-property">What is the purpose of the displayName class property?</a></td>
    </tr>
    <tr>
        <td>180</td>
    ...
    <tr>
        <td>184</td>
        <td><a href="#when-component-props-defaults-to-true">When do component props default to true?</a></td>
    </tr>
    <tr>
        <td>185</td>
        <td><a href="#what-is-nextjs-and-major-features-of-it">What is Next.js and its major features?</a></td>
    </tr>
    <tr>
        <td>186</td>
    ...
    <tr>
        <td>188</td>
        <td><a href="#how-jsx-prevents-injection-attacks">How does JSX prevent injection attacks?</a></td>
    </tr>
    <tr>
        <td>189</td>
   ...
   <tr>
        ...
        <tr>
            <td>195</td>
            <td><a href="#why-do-you-not-required-to-use-inheritance">Why are you not required to use inheritance?</a></td>
        </tr>
        <tr>
            <td>196</td>
  ...
  <tr>
    <td>203</td>
    <td><a href="#what-are-the-rules-covered-by-diffing-algorithm">What are the rules covered by a diffing algorithm?</a></td>
  </tr>
  <tr>
    <td>204</td>
  ...
  <tr>
    <td>210</td>
    <td><a href="#how-do-you-set-default-value-for-uncontrolled-component">How do you set a default value for an uncontrolled component?</a></td>
  </tr>
  <tr>
    <td>211</td>
  ...
  <tr>
    ...
    <tr>
        <td>218</td>
        <td><a href="#is-hooks-cover-all-use-cases-for-classes">Do Hooks cover all use cases for classes?</a></td>
    </tr>
    <tr>
        <td>219</td>
    ...
    <tr>
        <td>232</td>
        <td><a href="#can-i-use-javascript-urls-in-react169">Can I use JavaScript URLs in React 16.9?</a></td>
    </tr>
    <tr>
        <td>233</td>
    ...
    <tr>
        <td>236</td>
        <td><a href="#how-do-you-make-sure-that-user-remains-authenticated-on-page-refresh-while-using-context-api-state-management">How do you make sure that the user remains authenticated on page refresh while using Context API State Management?</a></td>
    </tr>
    <tr>
        <td>237</td>
    ...
    <tr>
        <td>238</td>
        <td><a href="#how-is-the-new-jsx-transform-different-from-old-transform">How is the new JSX transform different from the old transform?</a></td>
    </tr>
    <tr>
        <td>239</td>
    ...
    <tr>
        <td>269</td>
        <td><a href="#when-to-use-client-and-server-components">When to use client and server components?</a></td>
    </tr>
    <tr>
        <td>270</td>
        <td><a href="#what-are-the-differences-between-page-router-and-app-router-in-nextjs">What are the differences between page router and app router in Next.js?</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
      <td>8</td>
      <td><a href="#which-is-preferred-option-with-in-callback-refs-and-finddomnode">Which is preferred option within callback refs and findDOMNode()?</a></td>
    </tr>
    <tr>
      <td>9</td>
    ...
    <tr><td>21</td><td><a href="#is-it-good-to-use-setstate-in-componentwillmount-method">Is it good to use setState() in componentWillMount() method?</a></td></tr>
    <tr><td>22</td><td><a href="#what-will-happen-if-you-use-props-in-initial-state">What will happen if you use props in initial state?</a></td></tr>
    <tr><td>23</td><td><a href="#how-you-use-decorators-in-react">How do you use decorators in React?</a></td></tr>
    <tr><td>24</td><td><a href="#what-is-cra-and-its-benefits">What is CRA and its benefits?</a></td></tr>
    <tr><td>25</td><td><a href="#what-is-the-lifecycle-methods-order-in-mounting">What is the lifecycle methods order in mounting?</a></td></tr>
    <tr><td>26</td><td><a href="#what-are-the-lifecycle-methods-going-to-be-deprecated-in-react-v16">What are the lifecycle methods going to be deprecated in React v16?</a></td></tr>
    <tr><td>27</td><td><a href="#what-is-the-purpose-of-getderivedstatefromprops-lifecycle-method">What is the purpose of getDerivedStateFromProps() lifecycle method?</a></td></tr>
    <tr><td>28</td><td><a href="#what-is-the-purpose-of-getsnapshotbeforeupdate-lifecycle-method">What is the purpose of getSnapshotBeforeUpdate() lifecycle method?</a></td></tr>
    <tr><td>29</td><td><a href="#what-is-the-recommended-way-for-naming-components">What is the recommended way for naming components?</a></td></tr>
    <tr><td>30</td><td><a href="#what-is-the-recommended-ordering-of-methods-in-component-class">What is the recommended ordering of methods in component class?</a></td></tr>
    <tr><td>31</td><td><a href="#why-we-need-to-pass-a-function-to-setstate">Why do we need to pass a function to setState()?</a></td></tr>
    <tr><td>32</td><td><a href="#why-is-ismounted-an-anti-pattern-and-what-is-the-proper-solution">Why is isMounted() an anti-pattern and what is the proper solution?</a></td></tr>
    <tr><td>33</td><td><a href="#what-is-the-difference-between-constructor-and-getinitialstate">What is the difference between constructor and getInitialState?</a></td></tr>
    <tr><td>34</td><td><a href="#can-you-force-a-component-to-re-render-without-calling-setstate">Can you force a component to re-render without calling setState?</a></td></tr>
    <tr><td>35</td><td><a href="#what-is-the-difference-between-super-and-superprops-in-react-using-es6-classes">What is the difference between super() and super(props) in React using ES6 classes?</a></td></tr>
    <tr><td>36</td><td><a href="#what-is-the-difference-between-setstate-and-replacestate-methods">What is the difference between setState and replaceState methods?</a></td></tr>
    <tr><td>37</td><td><a href="#how-to-listen-to-state-changes">How to listen to state changes?</a></td></tr>
    <tr><td>38</td><td><a href="#what-is-the-recommended-approach-of-removing-an-array-element-in-react-state">What is the recommended approach of removing an array element in React state?</a></td></tr>
    <tr><td>39</td><td><a href="#is-it-possible-to-use-react-without-rendering-html">Is it possible to use React without rendering HTML?</a></td></tr>
    <tr><td>40</td><td><a href="#what-are-the-possible-ways-of-updating-objects-in-state">What are the possible ways of updating objects in state?</a></td></tr>
    <tr><td>41</td><td><a href="#what-are-the-approaches-to-include-polyfills-in-your-create-react-app">What are the approaches to include polyfills in your create-react-app?</a></td></tr>
    <tr><td>42</td><td><a href="#how-to-use-https-instead-of-http-in-create-react-app">How to use HTTPS instead of HTTP in create-react-app?</a></td></tr>
    <tr><td>43</td><td><a href="#how-to-avoid-using-relative-path-imports-in-create-react-app">How to avoid using relative path imports in create-react-app?</a></td></tr>
    <tr><td>44</td><td><a href="#how-to-update-a-component-every-second">How to update a component every second?</a></td></tr>
    <tr><td>45</td><td><a href="#why-is-a-component-constructor-called-only-once">Why is a component constructor called only once?</a></td></tr>
    <tr><td>46</td><td><a href="#how-to-define-constants-in-react">How to define constants in React?</a></td></tr>
    <tr><td>47</td><td><a href="#how-to-programmatically-trigger-click-event-in-react">How to programmatically trigger click event in React?</a></td></tr>
    <tr><td>48</td><td><a href="#how-to-make-ajax-call-and-in-which-component-lifecycle-methods-should-i-make-an-ajax-call">How to make AJAX call and in which component lifecycle methods should I make an AJAX call?</a></td></tr>
    <tr><td>49</td><td><a href="#what-are-render-props">What are render props?</a></td></tr>
    <tr><td>50</td><td><a href="#how-to-dispatch-an-action-on-load">How to dispatch an action on load?</a></td></tr>
    <tr><td>51</td><td><a href="#how-to-use-connect-from-react-redux">How to use connect from React Redux?</a></td></tr>
    <tr><td>52</td><td><a href="#whats-the-purpose-of-at-symbol-in-the-redux-connect-decorator">What's the purpose of @ symbol in the redux connect decorator?</a></td></tr>
    <tr>
    <td>53</td>
